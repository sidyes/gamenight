    ...
    <div class="section has-text-light">
      <div class="container">
        <div>
          ...
          <h3 class="title is-3 mt-20">Arten der verarbeiteten Daten</h3>
          <ul>
            <li>
          ...
          <h3 class="title is-3 mt-20">Kategorien betroffener Personen</h3>
          <ul>
            <li>
              <p>Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</p>
            </li>
          </ul>
          <h3 class="title is-3 mt-20">Zwecke der Verarbeitung</h3>
          <ul>
            <li>
          ...
          <ul class="m-elements"></ul>
          <h2 id="m27" class="title is-2 mt-30">Sicherheitsmaßnahmen</h2>
          <p>
          ...
          <h2 id="m12" class="title is-2 mt-30">Löschung von Daten</h2>
          <p>
